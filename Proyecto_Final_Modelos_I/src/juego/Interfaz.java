...
import mediator.Paneles;
import mediator.Buttons;
import mediator.FondoGeneral;
import mediator.FondoMadera_1;
import facade.Facade;
import mediator.Menus;
import mediator.FondoMadera_2;
import mediator.Texts;
import mediator.Labels;
import observer.*;
import java.awt.*;
...
////        objObservado.agregarObservador(observador);
        ...
        fachada.getMediatorInterfaz().crear(this, this,objObservado,observador );
...
////        setVisible(true);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        fachada.getMediatorLogica(ae).crear(this, this, objObservado, observador);
